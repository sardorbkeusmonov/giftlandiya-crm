...
Instagram-based Giftlandiya CRM for managing sales teams, inventory, delivery, and analytics. The UI is in Uzbek. The entire application is a single static HTML file deployed to Firebase Hosting.
